...
public class DailyReminder extends JobService {

    public static final String TAG = DailyReminder.class.getSimpleName();
    ...
    private void getFilm(final JobParameters job){
        Log.d(TAG, "Running");

        AsyncHttpClient client = new AsyncHttpClient();
        String url = MainActivity.baseUrl + "/3/movie/now_playing" ;
